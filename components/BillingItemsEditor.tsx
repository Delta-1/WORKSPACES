...
import { itemsTotal, newBillingItem, type BillingItem } from "@/lib/billing";
    ...
    <div className="space-y-2">
      ...
      <div className="bg-white/5 border border-white/10 rounded-lg p-2.5">
        <div className="flex items-center justify-between mb-1.5">
          ...
          <button type="button" onClick={() => setItens([...itens, newBillingItem()])} className="text-xs px-2 py-1 rounded bg-white/10 hover:bg-white/15 flex items-center gap-1"><Plus size={12} /> item</button>
        </div>
