...
export type Semente = {
  titulo: string;
  autor?: string;
  /** Área do conhecimento — o nível de cima na estante. */
  area: string;
  materia: string;
  tipo?: string;
  idioma?: string;
...
export const ACERVO_ABERTO: Semente[] = [
  {
    titulo: "StatPearls",
    area: "Saúde", materia: "Clínica Médica", tipo: "Referência", idioma: "en",
  ...
  },
  {
    ...
    area: "Saúde", materia: "Anatomia", tipo: "Livro", idioma: "en", ano: 2022,
  ...
  },
  {
    ...
    area: "Saúde", materia: "Microbiologia", tipo: "Livro", idioma: "en", ano: 2016,
    licenca: "CC BY 4.0", fonte: "OpenStax (Rice University)",
  ...
  },
  {
    ...
    area: "Saúde", materia: "Biologia", tipo: "Livro", idioma: "en", ano: 2018,
    licenca: "CC BY 4.0", fonte: "OpenStax (Rice University)",
  ...
  },
  {
    ...
    area: "Saúde", materia: "Bioquímica", tipo: "Livro", idioma: "en", ano: 2019,
    licenca: "CC BY 4.0", fonte: "OpenStax (Rice University)",
  ...
  },
  {
    ...
    area: "Saúde", materia: "Psiquiatria", tipo: "Livro", idioma: "en", ano: 2020,
    licenca: "CC BY 4.0", fonte: "OpenStax (Rice University)",
  ...
  },
  {
    ...
    area: "Saúde", materia: "Anatomia", tipo: "Livro", idioma: "en", ano: 1918,
  ...
  },
  {
    ...
    area: "Saúde", materia: "Saúde Coletiva", tipo: "Coleção", idioma: "pt",
  ...
  },
  {
    ...
    area: "Saúde", materia: "Clínica Médica", tipo: "Base", idioma: "en",
  ...
  },
  {
    ...
    area: "Educação", materia: "Pesquisa", tipo: "Base", idioma: "en",
  ...
  },
  {
    ...
    area: "Educação", materia: "Pesquisa", tipo: "Base", idioma: "pt",
  ...
  },
  {
    ...
    area: "Saúde", materia: "Saúde Coletiva", tipo: "Diretriz", idioma: "en",
